...
function goToProducts(category) {
  ...
  { name: "(PV Tanpa Garansi) 12 Bulan", price: "Rp300.000" }
    ...
    renderProducts([
      { name: "(SHARING - Tanpa Garansi) 1 Hari", price: "Rp3.000" },
      { name: "(SHARING - Tanpa Garansi) 1 Minggu", price: "Rp6.000" },
      { name: "(SHARING - Tanpa Garansi) 1 Bulan", price: "Rp12.000" },
      { name: "(SHARING - Tanpa Garansi) 2 Bulan", price: "Rp20.000" },
      { name: "(SHARING - Tanpa Garansi) 3 Bulan", price: "Rp28.000" },
      { name: "(SHARING - Tanpa Garansi) 4 Bulan", price: "Rp36.000" },
      { name: "(SHARING - Tanpa Garansi) 5 Bulan", price: "Rp44.000" },
      { name: "(SHARING - Tanpa Garansi) 6 Bulan", price: "Rp52.000" },
      { name: "(SHARING - Tanpa Garansi) 7 Bulan", price: "Rp60.000" },
      { name: "(SHARING - Tanpa Garansi) 8 Bulan", price: "Rp68.000" },
      { name: "(SHARING - Tanpa Garansi) 9 Bulan", price: "Rp76.000" },
      { name: "(SHARING - Tanpa Garansi) 10 Bulan", price: "Rp84.000" },
      { name: "(SHARING - Tanpa Garansi) 11 Bulan", price: "Rp92.000" },
      { name: "(SHARING - Tanpa Garansi) 12 Bulan", price: "Rp100.000" }
    ]);
  }
}
